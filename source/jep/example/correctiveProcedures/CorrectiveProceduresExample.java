...
public class CorrectiveProceduresExample extends AbstractExample {
    ...
    public Class<?>[] getRelevantClasses() {
        Class<?>[] relevantClasses = {AbstractSolution.class, FitnessComparator.class,
                OptimizationProblem.class, Solution.class, AbstractCorrectiveProcedure.class,
                InitialSolutionConstructor.class, AcceptanceFunction.class, NeighborFunction.class,
                BreakCondition.class, ThresholdAcceptingProcedure.class,
                ThresholdBreakCondition.class, ThresholdSinkingFunction.class,
                SimulatedAnnealingProcedure.class, AnnealingFunction.class};
