...
public class StreamApiExample extends AbstractExample {
    ...
    public String run(String... arguments) {
        ...
        logln();
        logln("Turning above array into a stream, filtering the stream (allowing values < "+border+") and returning the maximal of the remaining values as result:");
    ...
    public String[] getRelevantClassesInformation() {
        String[] relevantClasses = {StreamApiExample.class.getSimpleName(),
                StreamApiExample.class.getSimpleName() + "." + Person.class.getSimpleName()};
